...
function Editor() {
    ...
    //set values saved values to input fields of selected section
    useEffect(() => {
    ...
    //set saved values to input fields when activedetailindex is changed
    useEffect(() => {
        const details = activeInformation?.details;
        if (!details) return;
    ...
    //All input fields of every section
    const basicInfoBody = (
    ...
    //Select which section input fields should shown as per user selection
    const generateBody = () => {
        switch (sections[activeSectionKey]) {
            case sections.basicInfo:
        ...
        <div className={styles.container}>
            ...
            <div className={styles.body}>
                ...
                <div className={styles.chips}>
                    ...
                    {
                        activeInformation?.details &&
                        <div className={isNewActive ? styles.new : styles.new_disabled} onClick={handleAddNew}>
                            +Add New
                        </div>
                    }
                </div>
